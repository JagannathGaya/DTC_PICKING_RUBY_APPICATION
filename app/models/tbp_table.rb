...
class TbpTable < ApplicationRecord
  ...
  # You do not need the id column in the oracle table itself, just in the create statement for the test
  # postgreSQL DB table definition
  # side effect: do not use the find method, always use where
